...
namespace BandTracker
{
  public class Band
  {
    ...
    public List<Venue> GetVenues()
    {
      ...
      SqlCommand cmd = new SqlCommand("SELECT venues.* FROM venues JOIN bands_venues ON (venues.id = bands_venues.venue_id) JOIN bands ON (bands_venues.band_id = bands.id) WHERE bands.id = @BandId;", conn);
